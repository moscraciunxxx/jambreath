...
export function fixtureResult(): JamBreathResult {
  ...
  return {
    ...
    destination: { lat: 34.0736, lon: -118.2400 },
    ...
    flowSamples: [
      { point: { lat: 34.055, lon: -118.244 }, currentSpeed: 18, freeFlowSpeed: 45, currentTravelTime: 120, freeFlowTravelTime: 48, confidence: 0.9, roadClosure: false, relativeSpeed: 18 / 45 },
      { point: { lat: 34.062, lon: -118.242 }, currentSpeed: 12, freeFlowSpeed: 40, currentTravelTime: 180, freeFlowTravelTime: 54, confidence: 0.85, roadClosure: false, relativeSpeed: 12 / 40 },
      { point: { lat: 34.068, lon: -118.241 }, currentSpeed: 25, freeFlowSpeed: 40, currentTravelTime: 90, freeFlowTravelTime: 56, confidence: 0.8, roadClosure: false, relativeSpeed: 25 / 40 },
    ],
    jammyCount: 2,
